...
public abstract class ToitPrimaryLanguageElementBase<S extends PsiElement, T extends ToitStubElement<S>>
        extends ToitBaseStubableElement<T>
        implements ToitPrimaryLanguageElement, StubBasedPsiElement<T> {
    public ToitPrimaryLanguageElementBase(@NotNull T stub, @NotNull IStubElementType nodeType) {
        super(stub, nodeType);
    }

    public ToitPrimaryLanguageElementBase(@NotNull ASTNode node) {
        super(node);
    }
